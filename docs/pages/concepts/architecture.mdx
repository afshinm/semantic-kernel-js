...
<Callout type="info">
The `@semantic-kernel/abstractions` package provides a set of interfaces and classes that allow for interaction with various AI services and it can be used
separately from the main `semantic-kernel` library!
</Callout>
