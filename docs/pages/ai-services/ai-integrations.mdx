...
- [OpenAI Provider](https://www.npmjs.com/package/@semantic-kernel/openai) (`@semantic-kernel/openai`) - Includes both OpenAI and Azure OpenAI support
- [Gemini Provider](https://www.npmjs.com/package/@semantic-kernel/gemini) (`@semantic-kernel/gemini`)
